...
public class FireGodArmorRenderer implements ArmorRenderer {

    private static final Identifier TEXTURE = new Identifier("skam", "textures/models/armor/fire_god_armor.png");
