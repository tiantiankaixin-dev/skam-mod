...
public class Level5LightningCore extends Item implements ICoreItem {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("tooltip.skam.upgrade.thunder_blade_1").formatted(Formatting.GRAY));
        tooltip.add(Text.translatable("tooltip.skam.upgrade.thunder_blade_2").formatted(Formatting.GRAY));
    }
    @Override
